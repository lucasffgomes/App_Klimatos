package com.giuliomachado.klimatus.api;
...
public class HTTPServiceFavorite extends AsyncTask<Void, Void, String> {

    private String city;

    private TextView realtime;
    private TextView cidadeAdicionada;  /* --*/
    ...
    public String doInBackground(Void... voids) {
        ...
        try {
            ...
            while (scanner.hasNext()) {
                resposta.append(scanner.next() + " "); // PEGAR ESPAÇOS ENTRE PALAVRAS
            }
    ...
    @Override
    protected void onPostExecute(String previsaotempo) {
        super.onPostExecute(String.valueOf(previsaotempo));

        try {
            //-------------------------------------------------------------
            JSONObject jsonObject = new JSONObject(previsaotempo);
            ...
            //String periodo = result.getString("currently");
