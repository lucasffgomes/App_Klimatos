...
import com.giuliomachado.klimatus.api.HTTPServiceFavorite;
...
public class ActivityFavorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        escreverCidade.setOnClickListener(new Button.OnClickListener(){
            @Override
            public void onClick(View v) {
                HTTPServiceFavorite service = new HTTPServiceFavorite("https://api.hgbrasil.com/weather?key=" + chaveAPI + "&city_name=" + etPrevisao.getText() + ",SP",
                        tvResposta,
                        tvCidade,
                        tvDescri,
                        tvUmidade,
